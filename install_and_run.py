...
{Colors.CYAN}
╔══════════════════════════════════════════════════════════════════════════════╗
║                          BackupFinder Auto-Setup v1.0.0                     ║
║                       One-Command Installation & Runner                       ║
║                           Created by MuhammadWaseem                           ║
║                   GitHub: https://github.com/MuhammadWaseem29                  ║
╚══════════════════════════════════════════════════════════════════════════════╝
{Colors.END}

{Colors.YELLOW}[INFO] Automatic Go installation and BackupFinder setup tool{Colors.END}
{Colors.GREEN}[INFO] No manual installation required - everything automated!{Colors.END}""")
